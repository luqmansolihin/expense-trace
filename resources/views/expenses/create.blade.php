...
<div x-data="{ 
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <h1 class="font-display text-2xl sm:text-3xl font-bold text-slate-900 leading-tight">Tambah Histori Biaya Lain-lain</h1>
            <p class="text-slate-600 text-xs sm:text-sm mt-1">Isi formulir pencatatan pengeluaran operasional di luar tiket dan hotel.</p>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                    ...
                    <div>
                        ...
                        @if(!Auth::user()->isAdmin())
                            <div class="w-full glass-input rounded-xl px-4 py-2.5 text-sm bg-emerald-50 flex items-center justify-between border border-emerald-300">
                                <span class="inline-flex items-center gap-2 font-semibold text-emerald-800">
