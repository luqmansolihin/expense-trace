...
<body>
    ...
    <div class="container">
        ...
        <div class="body-content">
            ...
            @if($ticket->notes)
                <div class="section-box">
                    ...
                    <div style="color: #334155; font-style: italic;">{{ $ticket->notes }}</div>
                </div>
            @endif
        ...
        <div class="barcode-section">
            ...
            <div class="footer-text">VERIFIED HISTORICAL TICKET RECORD • {{ $ticket->ticket_code ?: '-' }} • EXPENSETRACE SYSTEM</div>
        </div>
    </div>
